...
def main():
    ...
    classifier = ClassifierHead(d_model=D_MODEL, num_classes=NUM_CLASSES)

    encoder_output = encoder(token_ids)
    class_logits = classifier(encoder_output)

    print(f"Classification outputs for a batch of 3 sequences: {class_logits}")
    print(f"Encoder output shape: {encoder_output.shape}")
    print(f"Classification head output shape: {class_logits.shape}")
