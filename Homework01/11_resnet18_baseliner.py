...
PRETRAINED_MODEL_SAVE_PATH = "best_resnet18_finetuned.pt"
...
def main():
    ...
    print(f"ResNet-18 Test Avg Loss: {loss_ft:.3f}")
    print(f"ResNet-18 Test Accuracy:  {acc_ft:.3f}")
    print(f"ResNet-18 Test Macro F1:  {f1_ft:.3f}")
    print(f"ResNet-18 Test Per-class F1: {pretty_dict_ft}")
